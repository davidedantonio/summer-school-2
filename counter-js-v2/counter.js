...
function renderComponent () {
  document.getElementById('root').innerHTML = `State ${state} Prop: ${propCount} Prop Doubled: ${propCountDoubled}`;
}
...
document.getElementById('btn-prop').addEventListener('click', incrementPropCount);
